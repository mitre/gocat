...
func main() {
	...
	contactConfig := contact.BuildContactConfig(trimmedServer, *c2Protocol, c2Key, *httpProxyUrl, tunnelConfig)
	core.Core(contactConfig, *group, *delay, *listenP2P, *verbose, *paw, *originLinkID)
}
