...
func initializeCore(server string, group string, c2 map[string]string, p2pReceiversOn bool, initialDelay int, verbose bool, paw string, originLinkID string) (*agent.Agent, error) {
...
func Core(server string, group string, delay int, c2 map[string]string, p2pReceiversOn bool, verbose bool, paw string, originLinkID string) {
